...
public class OrderService : IOrderService
{
    ...
    public async Task<ServiceResult<Order>> CreateOrderAsync(int customerId, IReadOnlyList<NewOrderLine> lines)
    {
        ...
        var validationError = ValidateNewOrderRequest(customer, lines);
        ...
        {
            var item = await BuildOrderItemAsync(line, errors);
            if (item is not null)
    ...
    private async Task<OrderItem?> BuildOrderItemAsync(NewOrderLine line, List<string> errors)
    {
